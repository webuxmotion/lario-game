...
var Player = /*#__PURE__*/function () {
  function Player() {
    ...
    this.sprites = {
      ...
      shoot: {
        fireFlower: {
          right: _images__WEBPACK_IMPORTED_MODULE_1__["default"].spriteFireFlowerShootRight,
          left: _images__WEBPACK_IMPORTED_MODULE_1__["default"].spriteFireFlowerShootLeft
        }
      }
    };
  ...
  _createClass(Player, [{
    ...
    value: function update(_ref2) {
      ...
      if (this.currentSprite === this.sprites.stand.right || this.currentSprite === this.sprites.stand.left || this.currentSprite === this.sprites.stand.fireFlower.right || this.currentSprite === this.sprites.stand.fireFlower.left) {
        ...
        this.frames = 0;
      } else if (this.currentSprite === this.sprites.jump.right || this.currentSprite === this.sprites.jump.left || this.currentSprite === this.sprites.jump.fireFlower.right || this.currentSprite === this.sprites.jump.fireFlower.left || this.currentSprite === this.sprites.shoot.fireFlower.right || this.currentSprite === this.sprites.shoot.fireFlower.left) {
        this.frames = 0;
      }
...
/* harmony import */ var _getGoombas__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./getGoombas */ "./src/js/getGoombas.js");
...
function init() {
  ...
  particles = [];
  flowers = Object(_getFlowers__WEBPACK_IMPORTED_MODULE_7__["getFlowers1"])();
...
function initLevel2() {
  ...
  particles = [];
  flowers = Object(_getFlowers__WEBPACK_IMPORTED_MODULE_7__["getFlowers2"])();
  ...
  flagPole = new _GenericObject__WEBPACK_IMPORTED_MODULE_3__["default"]({
    x: 7780,
    y: canvas.height - _images__WEBPACK_IMPORTED_MODULE_5__["default"].level2.lgPlatform.height - _images__WEBPACK_IMPORTED_MODULE_5__["default"].flagPole.height,
    image: _images__WEBPACK_IMPORTED_MODULE_5__["default"].flagPole
  });
}
...
function animate() {
  ...
  if (!game.disableUserInput && Object(_utils__WEBPACK_IMPORTED_MODULE_6__["objectsTouch"])({
    object1: player,
    object2: flagPole
  })) {
    var _spriteStandRight;

    var _spriteRunRight;

    if (player.powerUps.fireFlower) {
      _spriteStandRight = player.sprites.stand.fireFlower.right;
      _spriteRunRight = player.sprites.run.fireFlower.right;
    } else {
      _spriteStandRight = player.sprites.stand.right;
      _spriteRunRight = player.sprites.run.right;
    }

    _audio__WEBPACK_IMPORTED_MODULE_1__["audio"].completeLevel.play();
    _audio__WEBPACK_IMPORTED_MODULE_1__["audio"].musicLevel1.stop();
    game.disableUserInput = true;
    player.velocity.x = 0;
    player.velocity.y = 0;
    player.currentSprite = _spriteStandRight;
    gravity = 0; // flagpole slide

    setTimeout(function () {
      _audio__WEBPACK_IMPORTED_MODULE_1__["audio"].descend.play();
    }, 200);
    gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(player.position, {
      y: flagPole.position.y + flagPole.height - player.height,
      duration: 1,
      onComplete: function onComplete() {
        player.currentSprite = _spriteRunRight;
      }
    });
    gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(player.position, {
      x: canvas.width,
    ...
    var intervalId = setInterval(function () {
      for (var i = 0; i < particleCount; i++) {
        particles.push(new _Particle__WEBPACK_IMPORTED_MODULE_9__["default"]({
          position: {
      ...
      _audio__WEBPACK_IMPORTED_MODULE_1__["audio"].fireworkBurst.play();
  ...
  flowers.forEach(function (flower, index) {
    if (Object(_utils__WEBPACK_IMPORTED_MODULE_6__["objectsTouch"])({
      ...
      _audio__WEBPACK_IMPORTED_MODULE_1__["audio"].obtainPowerUp.play();
  ...
  goombas.forEach(function (goomba, index) {
    ...
    particles.forEach(function (particle, particleIndex) {
      if (particle.fireball && particle.position.x + particle.radius >= goomba.position.x && particle.position.x - particle.radius <= goomba.position.x + goomba.width && particle.position.y + particle.radius >= goomba.position.y && particle.position.y - particle.radius <= goomba.position.y + goomba.height) {
        _audio__WEBPACK_IMPORTED_MODULE_1__["audio"].fireworkBurst.play();
        Object(_utils__WEBPACK_IMPORTED_MODULE_6__["generateExplosion"])({
          particles: particles,
          object: goomba
        });
        setTimeout(function () {
    ...
    if (Object(_utils__WEBPACK_IMPORTED_MODULE_6__["collisitionTop"])({
      object1: player,
      object2: goomba
    })) {
      _audio__WEBPACK_IMPORTED_MODULE_1__["audio"].goombaSquash.play();
      Object(_utils__WEBPACK_IMPORTED_MODULE_6__["generateExplosion"])({
        particles: particles,
        object: goomba
      });
      ...
      if (player.powerUps.fireFlower) {
        ...
        _audio__WEBPACK_IMPORTED_MODULE_1__["audio"].losePowerUp.play();
        setTimeout(function () {
  ...
  if (keys.right.pressed && player.position.x + player.width < canvas.width / 2) {
    ...
    if (keys.right.pressed) {
      for (var i = 0; i < platforms.length; i++) {
        ...
        if (platform.block && Object(_utils__WEBPACK_IMPORTED_MODULE_6__["hitSideOfPlatform"])({
          object: player,
          platform: platform
        })) {
      ...
      for (var _i = 0; _i < platforms.length; _i++) {
        ...
        if (_platform.block && Object(_utils__WEBPACK_IMPORTED_MODULE_6__["hitSideOfPlatform"])({
          object: player,
          platform: _platform
        })) {
          platforms.forEach(function (el) {
  ...
  platforms.forEach(function (platform) {
    if (Object(_utils__WEBPACK_IMPORTED_MODULE_6__["isOnTopOfPlatform"])({
      object: player,
      platform: platform
    })) {
      player.velocity.y = 0;
    ...
    if (platform.block && Object(_utils__WEBPACK_IMPORTED_MODULE_6__["hitBottomOfPlatform"])({
      object: player,
      platform: platform
    })) {
    ...
    particles.forEach(function (particle, index) {
      if (Object(_utils__WEBPACK_IMPORTED_MODULE_6__["isCircleOnTopOfPlatform"])({
        object: particle,
        platform: platform
      })) {
  ...
  switch (code) {
    ...
    case "KeyW":
      if (player.velocity.y === 0) {
        _audio__WEBPACK_IMPORTED_MODULE_1__["audio"].jump.play();
    ...
    case "KeyF":
      ...
      _audio__WEBPACK_IMPORTED_MODULE_1__["audio"].fireFlowerShot.play();
      var velocity = 15;
...
/*!******************************!*\
  !*** ./src/js/getFlowers.js ***!
  \******************************/
/*! exports provided: getFlowers1, getFlowers2 */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFlowers1", function() { return getFlowers1; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFlowers2", function() { return getFlowers2; });
/* harmony import */ var _Flower__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Flower */ "./src/js/Flower.js");


var getFlowers1 = function getFlowers1() {
...
var getFlowers2 = function getFlowers2() {
  return [new _Flower__WEBPACK_IMPORTED_MODULE_0__["default"]({
    position: {
      x: 4734 - 28,
      y: 100
...
var getGoombas2 = function getGoombas2() {
  return [new _Goomba__WEBPACK_IMPORTED_MODULE_0__["default"]({
    // single block goomba
    position: {
      x: 903 + _images__WEBPACK_IMPORTED_MODULE_1__["default"].level2.mdPlatform.width - goombaWidth,
      y: 100
    },
    velocity: {
      x: -2,
    ...
    // single block goomba
    position: {
      x: 1878 + _images__WEBPACK_IMPORTED_MODULE_1__["default"].level2.lgPlatform.width + 155 + 200 + 200 + 200 + _images__WEBPACK_IMPORTED_MODULE_1__["default"].block.width / 2 - goombaWidth / 2,
      y: 100
    },
    velocity: {
      x: 0,
    ...
    position: {
      x: 3831 + _images__WEBPACK_IMPORTED_MODULE_1__["default"].level2.lgPlatform.width - goombaWidth,
      y: 100
    },
    velocity: {
      x: -1,
    ...
    distance: {
      limit: _images__WEBPACK_IMPORTED_MODULE_1__["default"].level2.lgPlatform.width - goombaWidth,
      traveled: 0
    }
  }), new _Goomba__WEBPACK_IMPORTED_MODULE_0__["default"]({
    position: {
...
var getPlatforms1 = function getPlatforms1(_ref) {
  ...
  var platforms = [new _GenericObject__WEBPACK_IMPORTED_MODULE_0__["default"]({
    ...
    y: canvas.height - _images__WEBPACK_IMPORTED_MODULE_1__["default"].platform.height - 500,
    ...
    x: 6968 + 300 + _images__WEBPACK_IMPORTED_MODULE_1__["default"].lgPlatform.width - 2,
    y: canvas.height - _images__WEBPACK_IMPORTED_MODULE_1__["default"].lgPlatform.height,
    image: _images__WEBPACK_IMPORTED_MODULE_1__["default"].lgPlatform,
    block: true
  })];
...
var getPlatforms2 = function getPlatforms2(_ref2) {
  ...
  var platforms = [new _GenericObject__WEBPACK_IMPORTED_MODULE_0__["default"]({
    x: 903 + _images__WEBPACK_IMPORTED_MODULE_1__["default"].level2.mdPlatform.width + 115,
    y: canvas.height - 300,
    image: _images__WEBPACK_IMPORTED_MODULE_1__["default"].blockTri,
    block: true
  }), new _GenericObject__WEBPACK_IMPORTED_MODULE_0__["default"]({
    x: 903 + _images__WEBPACK_IMPORTED_MODULE_1__["default"].level2.mdPlatform.width + 115 + _images__WEBPACK_IMPORTED_MODULE_1__["default"].blockTri.width,
    y: canvas.height - 600,
    image: _images__WEBPACK_IMPORTED_MODULE_1__["default"].blockTri,
    block: true
  }), new _GenericObject__WEBPACK_IMPORTED_MODULE_0__["default"]({
    x: 1878 + _images__WEBPACK_IMPORTED_MODULE_1__["default"].level2.lgPlatform.width + 175,
    y: canvas.height - 300,
    image: _images__WEBPACK_IMPORTED_MODULE_1__["default"].block,
    block: true
  }), new _GenericObject__WEBPACK_IMPORTED_MODULE_0__["default"]({
    x: 1878 + _images__WEBPACK_IMPORTED_MODULE_1__["default"].level2.lgPlatform.width + 155 + 200,
    y: canvas.height - 360,
    image: _images__WEBPACK_IMPORTED_MODULE_1__["default"].block,
    block: true
  }), new _GenericObject__WEBPACK_IMPORTED_MODULE_0__["default"]({
    x: 1878 + _images__WEBPACK_IMPORTED_MODULE_1__["default"].level2.lgPlatform.width + 155 + 200 + 200,
    y: canvas.height - 330,
    image: _images__WEBPACK_IMPORTED_MODULE_1__["default"].block,
    block: true
  }), new _GenericObject__WEBPACK_IMPORTED_MODULE_0__["default"]({
    x: 1878 + _images__WEBPACK_IMPORTED_MODULE_1__["default"].level2.lgPlatform.width + 155 + 200 + 200 + 200,
    y: canvas.height - 240,
    image: _images__WEBPACK_IMPORTED_MODULE_1__["default"].block,
    block: true
  }), new _GenericObject__WEBPACK_IMPORTED_MODULE_0__["default"]({
    x: 4734 - _images__WEBPACK_IMPORTED_MODULE_1__["default"].level2.mdPlatform.width / 2,
    y: canvas.height - _images__WEBPACK_IMPORTED_MODULE_1__["default"].level2.lgPlatform.height - _images__WEBPACK_IMPORTED_MODULE_1__["default"].level2.mdPlatform.height,
    image: _images__WEBPACK_IMPORTED_MODULE_1__["default"].level2.mdPlatform
  }), new _GenericObject__WEBPACK_IMPORTED_MODULE_0__["default"]({
    x: 5987,
    y: canvas.height - _images__WEBPACK_IMPORTED_MODULE_1__["default"].level2.lgPlatform.height - _images__WEBPACK_IMPORTED_MODULE_1__["default"].level2.mdPlatform.height,
    image: _images__WEBPACK_IMPORTED_MODULE_1__["default"].level2.mdPlatform
    ...
    x: 5987,
    y: canvas.height - _images__WEBPACK_IMPORTED_MODULE_1__["default"].level2.lgPlatform.height - _images__WEBPACK_IMPORTED_MODULE_1__["default"].level2.mdPlatform.height * 2,
    image: _images__WEBPACK_IMPORTED_MODULE_1__["default"].level2.mdPlatform
  }), new _GenericObject__WEBPACK_IMPORTED_MODULE_0__["default"]({
    x: 6787,
    y: canvas.height - _images__WEBPACK_IMPORTED_MODULE_1__["default"].level2.lgPlatform.height - _images__WEBPACK_IMPORTED_MODULE_1__["default"].level2.mdPlatform.height,
    ...
    x: 6787,
    y: canvas.height - _images__WEBPACK_IMPORTED_MODULE_1__["default"].level2.lgPlatform.height - _images__WEBPACK_IMPORTED_MODULE_1__["default"].level2.mdPlatform.height * 3,
    image: _images__WEBPACK_IMPORTED_MODULE_1__["default"].level2.mdPlatform
  })];
  var platformsMap = ['lg', 'md', 'gap', 'gap', 'gap', 'lg', 'gap', 'gap', 'gap', 'gap', 'gap', 'gap', 'lg', 'lg', 'gap', 'gap', 'md', 'gap', 'gap', 'md', 'gap', 'gap', 'lg'];
  var platformDistance = 0;
  platformsMap.forEach(function (symbol) {
    switch (symbol) {
      case 'md':
        platforms.push(new _GenericObject__WEBPACK_IMPORTED_MODULE_0__["default"]({
          x: platformDistance,
          y: canvas.height - _images__WEBPACK_IMPORTED_MODULE_1__["default"].level2.mdPlatform.height,
          image: _images__WEBPACK_IMPORTED_MODULE_1__["default"].level2.mdPlatform,
          block: true
        }));
        platformDistance += _images__WEBPACK_IMPORTED_MODULE_1__["default"].level2.mdPlatform.width - 3;
        break;
      ...
      case 'lg':
        ...
        platformDistance += _images__WEBPACK_IMPORTED_MODULE_1__["default"].level2.lgPlatform.width - 3;
        break;
...
/* harmony import */ var _img_spriteFireFlowerShootLeft_png__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../img/spriteFireFlowerShootLeft.png */ "./src/img/spriteFireFlowerShootLeft.png");
/* harmony import */ var _img_spriteFireFlowerShootRight_png__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../img/spriteFireFlowerShootRight.png */ "./src/img/spriteFireFlowerShootRight.png");
/* harmony import */ var _img_blocks_png__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../img/blocks.png */ "./src/img/blocks.png");
/* harmony import */ var _img_spriteGoomba_png__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../img/spriteGoomba.png */ "./src/img/spriteGoomba.png");
/* harmony import */ var _img_block_png__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../img/block.png */ "./src/img/block.png");
/* harmony import */ var _img_blockTri_png__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ../img/blockTri.png */ "./src/img/blockTri.png");
/* harmony import */ var _img_spriteFireFlower_png__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ../img/spriteFireFlower.png */ "./src/img/spriteFireFlower.png");
/* harmony import */ var _img_lgPlatform_png__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ../img/lgPlatform.png */ "./src/img/lgPlatform.png");
/* harmony import */ var _img_tPlatform_png__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ../img/tPlatform.png */ "./src/img/tPlatform.png");
/* harmony import */ var _img_xtPlatform_png__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ../img/xtPlatform.png */ "./src/img/xtPlatform.png");
/* harmony import */ var _img_flagPole_png__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ../img/flagPole.png */ "./src/img/flagPole.png");
/* harmony import */ var _img_level2_background_png__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ../img/level2/background.png */ "./src/img/level2/background.png");
/* harmony import */ var _img_level2_mountains_png__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ../img/level2/mountains.png */ "./src/img/level2/mountains.png");
/* harmony import */ var _img_level2_lgPlatform_png__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ../img/level2/lgPlatform.png */ "./src/img/level2/lgPlatform.png");
/* harmony import */ var _img_level2_mdPlatform_png__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ../img/level2/mdPlatform.png */ "./src/img/level2/mdPlatform.png");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  level2: {
    background: Object(_utils__WEBPACK_IMPORTED_MODULE_0__["createImage"])(_img_level2_background_png__WEBPACK_IMPORTED_MODULE_27__["default"]),
    mountains: Object(_utils__WEBPACK_IMPORTED_MODULE_0__["createImage"])(_img_level2_mountains_png__WEBPACK_IMPORTED_MODULE_28__["default"]),
    lgPlatform: Object(_utils__WEBPACK_IMPORTED_MODULE_0__["createImage"])(_img_level2_lgPlatform_png__WEBPACK_IMPORTED_MODULE_29__["default"]),
    mdPlatform: Object(_utils__WEBPACK_IMPORTED_MODULE_0__["createImage"])(_img_level2_mdPlatform_png__WEBPACK_IMPORTED_MODULE_30__["default"])
  },
  ...
  spriteFireFlowerShootLeft: Object(_utils__WEBPACK_IMPORTED_MODULE_0__["createImage"])(_img_spriteFireFlowerShootLeft_png__WEBPACK_IMPORTED_MODULE_16__["default"]),
  spriteFireFlowerShootRight: Object(_utils__WEBPACK_IMPORTED_MODULE_0__["createImage"])(_img_spriteFireFlowerShootRight_png__WEBPACK_IMPORTED_MODULE_17__["default"]),
  blocks: Object(_utils__WEBPACK_IMPORTED_MODULE_0__["createImage"])(_img_blocks_png__WEBPACK_IMPORTED_MODULE_18__["default"]),
  goomba: Object(_utils__WEBPACK_IMPORTED_MODULE_0__["createImage"])(_img_spriteGoomba_png__WEBPACK_IMPORTED_MODULE_19__["default"]),
  block: Object(_utils__WEBPACK_IMPORTED_MODULE_0__["createImage"])(_img_block_png__WEBPACK_IMPORTED_MODULE_20__["default"]),
  blockTri: Object(_utils__WEBPACK_IMPORTED_MODULE_0__["createImage"])(_img_blockTri_png__WEBPACK_IMPORTED_MODULE_21__["default"]),
  flower: Object(_utils__WEBPACK_IMPORTED_MODULE_0__["createImage"])(_img_spriteFireFlower_png__WEBPACK_IMPORTED_MODULE_22__["default"]),
  lgPlatform: Object(_utils__WEBPACK_IMPORTED_MODULE_0__["createImage"])(_img_lgPlatform_png__WEBPACK_IMPORTED_MODULE_23__["default"]),
  tPlatform: Object(_utils__WEBPACK_IMPORTED_MODULE_0__["createImage"])(_img_tPlatform_png__WEBPACK_IMPORTED_MODULE_24__["default"]),
  xtPlatform: Object(_utils__WEBPACK_IMPORTED_MODULE_0__["createImage"])(_img_xtPlatform_png__WEBPACK_IMPORTED_MODULE_25__["default"]),
  flagPole: Object(_utils__WEBPACK_IMPORTED_MODULE_0__["createImage"])(_img_flagPole_png__WEBPACK_IMPORTED_MODULE_26__["default"])
});
